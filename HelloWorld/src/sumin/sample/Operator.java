...
public class Operator {
	public static void main(String[] args) {
		...
		// int3 = float1; //대입실패
		int3 = (int) long1;
		int3 = (int) float1; // 형 변환 필요

		// 다중 대입
		int int4 = 25;
		int int5, int6, int7, int8, int9, int10;
		int4 = int5 = 25;
		// int 4 = int5 = int6 = int7 = int8 = int9 = int10;
		// int10은 값이 없으므로 위 수식은 오류!
		...
		// byte3 = (byte) byte4 + byte5;
		// 수식의 결과는 int이므로 오류!!
		// 타입의 크기는 byte보다 int가 크므로 암시적으로 확대형 변환 실시
		...
		// 서로 다른 타입간 연산은 타입의 크기가 큰 쪽으로 지정됨
		// 명시적인 형 변환이 필요함
		...
		System.out.println("flot11 = " + float11);
		...
		bool5 = (int53 == int54);
		// bool5 = (int53 == int54 == int55); 연달아 쓰는 것은 오류
		// 컴파일 오류!
		// int53 == int54, int54 == int55 로 나눠서 써야함

		// 예) 90 <= avg <= 100 (x) 수식분리해야함
		// 예) avg >= 90, avg <= 100 (o) 변수는 왼쪽에
		System.out.println("bool15 =" + bool5);
